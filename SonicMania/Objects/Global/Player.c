...
void Player_JumpAbility_Sonic(void)
{
    ...
    if (ControllerInfo[self->controllerID].keyB.press && self->jumpAbilityState == 1) {
        self->jumpAbilityState = 0;
        self->velocity.x >>= 1;
    ...
    if (!ControllerInfo[self->controllerID].keyX.press && !ControllerInfo[self->controllerID].keyX.down && self->jumpPress
        && self->jumpAbilityState == 1) {
        self->jumpAbilityState = 0;
...
#endif
            if (ControllerInfo[self->controllerID].keyX.press
#if GAME_VERSION == VER_100
    ...
    if (!dropdashDisabled && ControllerInfo[self->controllerID].keyX.down) {  
